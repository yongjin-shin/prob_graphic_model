...
def var_dpmm_multinomial(X, alpha, base_dirichlet, T=10, n_iter=100, Xtest=None):
    '''
...
if __name__ == '__main__':
    ...
    g1, g2, tau, phi, ll, held_out = var_dpmm_multinomial(X, alpha, base_dirichlet, T=50, n_iter=50,
                                                          Xtest=X[0:, :])
    # g1, g2, tau, phi, ll, held_out = var_dpmm_multinomial(X[:1000, :], alpha, base_dirichlet, T=50, n_iter=50,
    #                                                       Xtest=X[1000:, :])
